...
activities = {
    ...
    "Art Studio": {
        "description": "Painting, drawing, and creative visual arts exploration",
    ...
    "Debate Team": {
        "description": "Public speaking, argumentation, and critical thinking skills",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ethan@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Competitive science challenges and academic competitions",
